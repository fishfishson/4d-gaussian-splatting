...
def readCamerasFromEasyVolcap(path, transformsfile, white_background, extension=".png", time_duration=None, frame_ratio=1, dataloader=False):
    cam_infos = []
...
def readEasyVolcapSceneInfo(path, white_background, eval=True, extension='.png', ply_path=None, num_pts=100_000, time_duration=None, num_extra_pts=0, frame_ratio=1, dataloader=False):
    print("Reading Training Transforms")
    train_cam_infos = readCamerasFromEasyVolcap(path, "transforms_train.json", white_background, extension, time_duration=time_duration, frame_ratio=frame_ratio, dataloader=dataloader)
    print("Reading Test Transforms")
    test_cam_infos = readCamerasFromEasyVolcap(path, "transforms_test.json", white_background, extension, time_duration=time_duration, frame_ratio=frame_ratio, dataloader=dataloader)
...
sceneLoadTypeCallbacks = {
    ...
    "EasyVolcap": readEasyVolcapSceneInfo,
}